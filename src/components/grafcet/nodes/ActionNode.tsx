  ...
  return (
    <div className="group relative">
      ...
      <Handle
        ...
        className={cn(
          "w-3 h-3 !bg-grafcet-action border-2 border-white opacity-0 group-hover:opacity-100 transition-opacity",
      ...
      <div
        className={cn(
          "min-w-24 max-w-48 h-12 px-4 bg-grafcet-action text-grafcet-action-foreground border-2 border-grafcet-action",
